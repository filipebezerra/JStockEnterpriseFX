...
public class SupplierMockData {
	...
	static {
		...
		supplierData.add(new SupplierTableModel("AddSolutions",
				"22.132.850/0001-86", "218 444 460"));
		supplierData.add(new SupplierTableModel("APN Publicidade Lda",
				"25.183.681/0001-00", "212 148 608"));
		supplierData.add(new SupplierTableModel("Dizplay Soundla",
				"33.431.254/0001-13", "214 197 111"));
		supplierData.add(new SupplierTableModel("Grupo Arena",
				"33.272.167/0001-60", "226 433 360"));
		supplierData.add(new SupplierTableModel("JR Design",
				"53.434.395/0001-05", "214338600"));
	}
