...
public class Supplier extends BaseEntity<Integer> implements Serializable {
	...
	public Supplier(final String companyName, final String tradingName,
			final String cnpj, final String publicArea, final String district,
			final String city, final Uf uf, final String cep) {
		this(null, companyName, tradingName, cnpj, publicArea, district, city,
				uf, cep);
	}

	public Supplier(final Integer id, final String companyName,
			final String tradingName, final String cnpj,
			final String publicArea, final String district, final String city,
			final Uf uf, final String cep) {
		this.id = id;
